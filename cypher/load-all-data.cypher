...
//
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/kvegter/gsummit2024/main/data/SECTION_ALL_Length.csv" AS row
WITH
...
// Load Speed Data
//
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/kvegter/gsummit2024/main/data/SECTION_ALL_Speed.csv" AS row
WITH
    trim(row.source) AS sourceId,
    trim(row.target) AS targetId,
...
//
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/kvegter/gsummit2024/main/data/POIs.csv' AS row
WITH 
    row.CITY AS city,
